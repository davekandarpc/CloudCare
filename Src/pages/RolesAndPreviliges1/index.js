...
import { getRequest, postRequest, updateRequest } from '../../common/fetchRequest';
...
const RolesAndPreviliges = () => {
    ...
    const [permissionDescriptionError, setPermissionDescriptionError] = useState('');
    ...
    const [selectedPermissionForAttaching, setSelectedPermissionForAttaching] = useState(null);
    const [selectedPermissionForAttachingError, setSelectedPermissionForAttachingError] = useState('');
                ...
                {!gettingRoles && !gettingPermissions &&
                    <>
                        ...
                        </div>
                        {
                            ...
                            <Grid container spacing={2} alignItems="center">
                                <Grid item xs={12} sm={4}>
                                    <Typography className={classes.textFiledLabel}>Roles</Typography>
                                    <TextField
                                        variant="outlined"
                                ...
                                <Grid item xs={12} sm={6} className={classes.button}>
                                    <FormButton
                                        ...
                                        variant="outlined"
                                        noBorder={true}
                                        buttonStyle={{ marginTop: roleDescriptionError !== '' ? 0 : 22 }}
                                    />
                                    <FormButton
                                        title="Create"
                                        onClick={createNewRole}
                                        loading={creatingRole}
                                        buttonStyle={{ marginTop: roleDescriptionError !== '' ? 0 : 22, marginLeft: 12 }}
                                    />
                                </Grid>
                            </Grid>
                        }
                        ...
                        >
                            ...
                            <DialogContent>
                                ...
                                <Grid alignItems="center">
                                    <Grid item xs={12} sm={4}>
                                        <Typography className={classes.textFiledLabel}>Role Description</Typography>
                                        <TextField
                                            variant="outlined"
                                            onChange={(event) => setRoleDescription(event.target.value)}
                                            error={roleDescriptionError !== ''}
                            ...
                            allPermissions.map((item, index) => {
                                return (
                                    <div className={classes.rolesTableRow}>
                                        ...
                                        <div className={classes.actionRow}>
                                            <IconButton onClick={() => onEditPermissionClick(item)} style={{ padding: 3 }}>
                                                <EditIcon fontSize="small" style={{ color: Colors.PRIMARY }} />
                                            </IconButton>
                                        </div>
                                    </div>
                        ...
                        </div>
                        {
                            addNewPermissionVisible &&
                            <Grid container spacing={2} alignItems="center">
                                <Grid item xs={12} sm={4} style={{ marginBottom: PermissionError === '' && permissionDescriptionError !== '' ? 22 : 0 }}>
                                    <Typography className={classes.textFiledLabel}>Permision</Typography>
                                    <TextField
                                        variant="outlined"
                                ...
                                <Grid item xs={12} sm={4} style={{ marginBottom: PermissionError !== '' && permissionDescriptionError === '' ? 22 : 0 }}>
                                    <Typography className={classes.textFiledLabel}>Permision Description</Typography>
                                    <TextField
                                        variant="outlined"
                        ...
                        >
                            ...
                            <DialogContent>
                                ...
                                <Grid container spacing={2}>
                                    <Grid item xs={12} sm={6} style={{ marginBottom: PermissionError === '' && permissionDescriptionError !== '' ? 22 : 0 }}>
                                        <Typography className={classes.textFiledLabel}>Permision</Typography>
                                        <TextField
                                            variant="outlined"
                                            onChange={(event) => setPermission(event.target.value)}
                        ...
                        >
                            ...
                            <DialogContent>
                                ...
                                <Grid container spacing={2}>
                                    <Grid item xs={12} sm={6} style={{ marginBottom: PermissionError === '' && permissionDescriptionError !== '' ? 22 : 0 }}>
                                        <Typography className={classes.textFiledLabel}>Select Permission</Typography>
                                        <TextField
                                            variant="outlined"
                                            onChange={(event) => setSelectedPermissionForAttaching(event.target.value)}
                                        ...
                                        >
                                            {allPermissions.map((option) => (
                                                <MenuItem key={option.permissionId} value={option.permissionId}>
